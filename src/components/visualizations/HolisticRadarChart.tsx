...
// Memoize Radar Chart component to prevent unnecessary re-renders
const MemoizedHolisticRadarChart = memo(HolisticRadarChart, (prevProps, nextProps) => {
...
export default MemoizedHolisticRadarChart;