            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="col-span-1 md:col-span-1">
                        <h3 className="text-white font-bold text-xl mb-4">PPSDM KM ITS</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            {/* Dashboard is hidden for non-logged in users in main nav, but okay to keep here if it redirects to login */}
                ...
                <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
                    <p>© 2026 PPSDM KM ITS - Institut Teknologi Sepuluh Nopember.</p>
                    <div className="flex gap-4">
