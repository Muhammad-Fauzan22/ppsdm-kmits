...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.refresh(); // Refresh to update server components/session state
        } catch (err: any) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-primary via-primary-light to-its-blue flex items-center justify-center p-6 font-display">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-white dark:bg-card-dark rounded-2xl shadow-2xl p-8">
                    ...
                    {/* Google Login (Mocking SSO for now, but ready for Supabase Google Auth) */}
                    <button
                        onClick={handleGoogleLogin}
                        type="button"
                        className="w-full py-3 border border-gray-200 dark:border-gray-700 rounded-xl font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors flex items-center justify-center gap-3"
                    >
                        {/* Using Google Icon loosely represented or reusing ITS Logo if preferred, but let's use text for clarity */}
