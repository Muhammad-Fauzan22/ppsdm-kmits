...
export default function LandingPage() {
    return (
        <div className="bg-its-dark font-sans text-slate-200 antialiased selection:bg-brand-blue selection:text-white">
                ...
                <header className="fixed top-0 z-[100] w-full border-b border-white/5 bg-its-dark/80 backdrop-blur-lg">
                    <div className="flex h-20 items-center justify-between px-6 lg:px-12 max-w-7xl mx-auto">
                        ...
                        <nav className="hidden lg:flex items-center gap-10">
                            <Link href="#how-it-works" className="text-sm font-medium hover:text-brand-accent transition-colors">Metodologi</Link>
                            <Link href="#dimensions" className="text-sm font-medium hover:text-brand-accent transition-colors">9 Dimensi</Link>
                            <Link href="#demo" className="text-sm font-medium hover:text-brand-accent transition-colors">Mission Control</Link>
                            <Link href="#faq" className="text-sm font-medium hover:text-brand-accent transition-colors">FAQ</Link>
                            <Link href="/auth/login" className="bg-brand-blue hover:bg-brand-blue/90 text-white px-6 py-2.5 rounded-full font-bold text-sm transition-all shadow-lg shadow-brand-blue/30 active:scale-95">
                                Mulai Sekarang
                            </Link>
                        </nav>
                    ...
                    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 py-24 text-center overflow-hidden its-gradient">
                        ...
                        <div className="relative z-10 max-w-5xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                                <Link href="/auth/login" className="w-full sm:w-auto px-8 py-5 bg-white text-its-blue font-bold rounded-2xl hover:bg-brand-accent transition-all hover:scale-105 shadow-2xl shadow-brand-accent/20 flex items-center justify-center gap-2 text-lg">
