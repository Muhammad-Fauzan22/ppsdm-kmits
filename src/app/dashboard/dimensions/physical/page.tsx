...
export default function PhysicalDimensionPage() {
  return (
      ...
      <header className="fixed top-0 w-full z-50 glass-panel border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <span className="text-xs uppercase tracking-widest text-slate-500">Dimension 07</span>
              <h1 className="text-xl font-bold font-display">Physical</h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-red-500 to-red-700 p-0.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white dark:bg-surface-dark rounded-2xl p-6 border border-gray-200 dark:border-white/10">
              <h2 className="text-xl font-bold mb-4">Physical Assessment</h2>
              <p className="text-slate-500 mb-6">
                Evaluate your fitness level, nutrition habits, and overall physical wellbeing.
              </p>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Strength & endurance</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Diet & hydration</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Rest & recovery</p>
                    </div>
                  </div>
                  <button className="px-4 py-2 bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-lg cursor-not-allowed">
                    Locked
