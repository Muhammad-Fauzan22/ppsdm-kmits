...
const mockRadarData = [
  { dimension: 'Kognitif', score: 75, previousScore: 70, target: 85, color: '#3b82f6', facultyAverage: 65 },
  { dimension: 'Manajemen Diri', score: 68, previousScore: 65, target: 80, color: '#10b981', facultyAverage: 60 },
  { dimension: 'Finansial', score: 60, previousScore: 55, target: 80, color: '#ef4444', facultyAverage: 58 },
  { dimension: 'Kesehatan Fisik', score: 82, previousScore: 80, target: 90, color: '#14b8a6', facultyAverage: 70 },
  { dimension: 'Emosional & Sosial', score: 78, previousScore: 75, target: 85, color: '#8b5cf6', facultyAverage: 72 },
  { dimension: 'Kesehatan Mental', score: 70, previousScore: 68, target: 85, color: '#6366f1', facultyAverage: 65 },
  { dimension: 'Karakter & Etika', score: 85, previousScore: 82, target: 90, color: '#f59e0b', facultyAverage: 75 },
  { dimension: 'Spiritual', score: 65, previousScore: 60, target: 80, color: '#f97316', facultyAverage: 62 },
  { dimension: 'Lingkungan', score: 72, previousScore: 68, target: 85, color: '#06b6d4', facultyAverage: 68 }
];
  ...
  children: [
    {
      ...
      value: 30,
      children: [
        { name: "Analysis", value: 10, mastery: 'mastered' as const },
        { name: "Evaluation", value: 10, mastery: 'developing' as const },
        { name: "Inference", value: 10, mastery: 'needs_work' as const }
      ]
    },
    {
      ...
      value: 30,
      children: [
        { name: "Identification", value: 15, mastery: 'mastered' as const },
        { name: "Solution Gen", value: 15, mastery: 'developing' as const }
      ]
    },
    {
      name: "Innovation",
      value: 40,
      children: [
        { name: "Creativity", value: 20, mastery: 'developing' as const },
        { name: "Adaptability", value: 20, mastery: 'needs_work' as const }
      ]
    }
  ]
};
