    ...
    return (
        <div className="h-full flex flex-col font-sans overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-900/50 backdrop-blur-md">
                ...
                {/* Search & Notifications removed/adapted as they are often in main dashboard header */}
            </div>
                ...
                <div className="max-w-[1600px] mx-auto w-full">
                    ...
                    <div className="grid grid-cols-12 gap-6 auto-rows-[minmax(100px,auto)]">
                        ...
                        <motion.div
                            ...
                            className="col-span-12 lg:col-span-8 bg-slate-900 rounded-2xl border border-slate-800 p-6 flex flex-col relative overflow-hidden group hover:border-blue-500/30 transition-all"
                        >
                            ...
                            <div className="flex justify-between items-start mb-6 z-10">
                                ...
                                <div className="flex gap-2 bg-black/20 p-1 rounded-lg border border-slate-800">
                                    <button className="px-3 py-1 text-xs font-medium bg-blue-600/20 text-white rounded shadow-sm">Analysis</button>
                            ...
                            <div className="flex flex-col lg:flex-row flex-1 gap-8 items-center justify-center relative z-10">
                                ...
                                <div className="flex-1 max-w-[500px] h-[320px] relative flex items-center justify-center">
                                    ...
                                    <svg className="w-full h-full drop-shadow-2xl" viewBox="0 0 400 360">
                                        ...
                                        <polygon fill="rgba(37, 99, 235, 0.5)" points="200,90 310,145 270,250 120,260 90,150" stroke="#2563eb" strokeWidth="3"></polygon>
                                        {/* Data Points */}
                                        <circle cx="200" cy="90" fill="#2563eb" r="4" stroke="white" strokeWidth="2"></circle>
                                        <circle cx="310" cy="145" fill="#2563eb" r="4" stroke="white" strokeWidth="2"></circle>
                                        <circle cx="270" cy="250" fill="#2563eb" r="4" stroke="white" strokeWidth="2"></circle>
                                        <circle cx="120" cy="260" fill="#2563eb" r="4" stroke="white" strokeWidth="2"></circle>
                                        <circle cx="90" cy="150" fill="#2563eb" r="4" stroke="white" strokeWidth="2"></circle>
                                    </svg>
                                </div>
                                {/* Legend / Stats */}
                                <div className="flex flex-col gap-4 min-w-[180px]">
                                    <div className="p-3 rounded-xl bg-black/20 border border-slate-800 flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            <div className="size-3 rounded-full bg-blue-600 border border-white"></div>
                                    ...
                                    <div className="p-3 rounded-xl bg-black/20 border border-slate-800 flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            <div className="size-3 rounded-full border-2 border-yellow-500 border-dashed"></div>
                                            <span className="text-sm font-medium text-white">Target</span>
                                        </div>
                                        <span className="text-lg font-bold font-grotesk text-yellow-500">900</span>
                                    </div>
                        ...
                        <motion.div
                            ...
                            className="col-span-12 lg:col-span-4 bg-slate-900 rounded-2xl border border-slate-800 p-6 flex flex-col hover:border-blue-500/30 transition-all"
                        >
                            ...
                            <div className="flex-1 flex flex-col gap-3 overflow-y-auto pr-1">
                                {/* High Priority Item */}
                                <div className="p-3 rounded-xl bg-blue-600/10 border border-blue-600/30 flex items-start gap-3 group hover:bg-blue-600/20 transition-all cursor-pointer">
                                    <div className="mt-1">
                                        <input className="rounded border-blue-600/50 text-blue-600 bg-transparent focus:ring-offset-slate-900 focus:ring-blue-600 size-4 cursor-pointer" type="checkbox" />
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                                            <h4 className="text-white font-medium text-sm leading-snug">Submit KMM Proposal</h4>
                                            <span className="text-[10px] font-bold text-yellow-500 bg-yellow-500/10 px-1.5 py-0.5 rounded border border-yellow-500/20">Urgent</span>
                                        </div>
                                        <p className="text-xs text-slate-400 mt-1">Deadline: Due in 2 days</p>
                                    </div>
                                    <button className="opacity-0 group-hover:opacity-100 transition-opacity bg-blue-600 text-white text-[10px] px-2 py-1 rounded font-bold self-center">Start</button>
                                </div>
                                {/* Suggested Item */}
                                <div className="p-3 rounded-xl bg-black/20 border border-slate-800 flex items-start gap-3 group hover:border-slate-500/30 transition-all cursor-pointer">
                                    <div className="mt-1">
                                        <input className="rounded border-slate-800 text-blue-600 bg-transparent focus:ring-offset-slate-900 focus:ring-blue-600 size-4 cursor-pointer" type="checkbox" />
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                        ...
                        <motion.div
                            ...
                            className="col-span-12 lg:col-span-4 bg-gradient-to-br from-blue-600 to-slate-900 rounded-2xl border border-blue-600/30 p-6 flex items-center justify-between relative overflow-hidden"
                        >
                            {/* Background Decor */}
                            ...
                            <div className="flex-1 z-10">
                                ...
                                <p className="text-yellow-400 font-bold text-xs uppercase tracking-wider pl-2">- Seno, Your Assistant</p>
                            </div>
                            <div className="w-24 h-24 shrink-0 relative z-10 flex items-center justify-center">
                                {/* Abstract Mascot Representation */}
                                <div className="w-20 h-20 bg-yellow-400 rounded-full flex items-center justify-center relative animate-bounce" style={{ animationDuration: "3s" }}>
                        ...
                        <motion.div
                            ...
                            className="col-span-12 lg:col-span-8 bg-slate-900 rounded-2xl border border-slate-800 p-6 hover:border-blue-500/30 transition-all"
                        >
                            <div className="flex justify-between items-center mb-6">
                                <div className="flex items-center gap-2">
                                ...
                                <div className="flex gap-4 text-sm text-slate-400">
                                    <span className="flex items-center gap-1"><span className="size-2 rounded-full bg-blue-600"></span> Study</span>
                                    <span className="flex items-center gap-1"><span className="size-2 rounded-full bg-yellow-500"></span> Focus</span>
                                </div>
                            </div>
                            <div className="flex flex-col lg:flex-row gap-8 items-center lg:h-[180px]">
                                ...
                                <div className="flex-1 h-full w-full flex items-end justify-between gap-2 px-2">
                                    <div className="w-full flex flex-col justify-end gap-2 group cursor-pointer h-full">
                                        <div className="w-full bg-white/5 rounded-t-sm h-[30%] group-hover:bg-blue-600/50 transition-colors"></div>
                                        <span className="text-xs text-slate-400 text-center">M</span>
                                    </div>
                                    <div className="w-full flex flex-col justify-end gap-2 group cursor-pointer h-full">
                                        <div className="w-full bg-white/5 rounded-t-sm h-[50%] group-hover:bg-blue-600/50 transition-colors"></div>
                                        <span className="text-xs text-slate-400 text-center">T</span>
                                    </div>
                                    <div className="w-full flex flex-col justify-end gap-2 group cursor-pointer h-full">
                                        <div className="w-full bg-blue-600 rounded-t-sm h-[80%] shadow-[0_0_15px_rgba(19,91,236,0.5)]"></div>
                                        <span className="text-xs text-white font-bold text-center">W</span>
                                    </div>
                                    <div className="w-full flex flex-col justify-end gap-2 group cursor-pointer h-full">
                                        <div className="w-full bg-white/5 rounded-t-sm h-[40%] group-hover:bg-blue-600/50 transition-colors"></div>
                                        <span className="text-xs text-slate-400 text-center">T</span>
                                    </div>
                                    <div className="w-full flex flex-col justify-end gap-2 group cursor-pointer h-full">
                                        <div className="w-full bg-white/5 rounded-t-sm h-[60%] group-hover:bg-blue-600/50 transition-colors"></div>
                                        <span className="text-xs text-slate-400 text-center">F</span>
                                    </div>
                                    <div className="w-full flex flex-col justify-end gap-2 group cursor-pointer h-full">
                                        <div className="w-full bg-white/5 rounded-t-sm h-[20%] group-hover:bg-blue-600/50 transition-colors"></div>
                                        <span className="text-xs text-slate-400 text-center">S</span>
                                    </div>
                                    <div className="w-full flex flex-col justify-end gap-2 group cursor-pointer h-full">
                                        <div className="w-full bg-white/5 rounded-t-sm h-[10%] group-hover:bg-blue-600/50 transition-colors"></div>
                                        <span className="text-xs text-slate-400 text-center">S</span>
                                    </div>
                                </div>
                                {/* Divider */}
                                ...
                                <div className="w-64 shrink-0 flex flex-col items-center justify-center gap-4">
                                    <div className="relative size-32">
                                        <svg className="size-full -rotate-90" viewBox="0 0 36 36">
                                            ...
                                            <path className="text-yellow-500" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="75, 100" strokeLinecap="round" strokeWidth="2.5"></path>
                                        </svg>
