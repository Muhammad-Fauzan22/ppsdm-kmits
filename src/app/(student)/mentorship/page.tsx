        ...
        <div className="min-h-screen bg-background-dark text-white font-sans overflow-x-hidden p-4 md:p-8">
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 bg-brand-blue hover:bg-blue-600 rounded-full text-white text-sm font-bold shadow-lg shadow-brand-blue/20 transition-all">
            ...
            <div className="flex flex-col xl:flex-row gap-8">
                ...
                <div className="flex-1 flex flex-col gap-8">
                    ...
                    <motion.div
                        ...
                        className="rounded-3xl overflow-hidden relative min-h-[320px] flex items-center justify-center p-6 md:p-12 border border-white/10 group"
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center gap-6 max-w-2xl">
                            ...
                            {/* Search Bar */}
                            <div className="w-full max-w-lg flex items-center p-1 bg-black/40 border border-white/20 rounded-xl backdrop-blur shadow-2xl focus-within:border-brand-blue/50 transition-colors">
                                ...
                                <button className="bg-brand-blue hover:bg-blue-600 text-white font-bold h-10 px-6 rounded-lg transition-colors shadow-lg shadow-brand-blue/20">
                                    Find
                                </button>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        {['Python', 'UI Design', 'Public Speaking', 'Level 5+ Only'].map((tag, i) => (
                            <button key={i} className={`flex h-9 items-center gap-2 rounded-full border px-4 transition-colors ${i === 2 ? 'bg-brand-blue text-white border-brand-blue' : 'bg-white/5 border-white/10 hover:border-brand-blue/50 hover:text-white text-slate-400'}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {[
                            ...
                            <motion.div
                                ...
                                className="group flex flex-col bg-card-dark rounded-xl border border-white/10 p-5 hover:border-brand-blue/50 hover:shadow-lg hover:shadow-brand-blue/10 transition-all duration-300 glass-card"
                            >
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex gap-3">
                                        <div className="relative">
                                            ...
                                            <div className={`absolute bottom-0 right-0 size-3 rounded-full border-2 border-card-dark ${mentor.status === 'online' ? 'bg-emerald-500' : 'bg-slate-500'}`} title={mentor.status}></div>
                                        </div>
                                        <div>
                                            <h4 className="font-bold text-white text-lg leading-tight group-hover:text-brand-blue transition-colors">{mentor.name}</h4>
                                            <span className="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded bg-brand-blue/10 text-brand-blue text-xs font-bold uppercase tracking-wide">
                                                Lvl {mentor.lvl}
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div className="mt-auto flex items-center justify-between border-t border-white/10 pt-4">
                                    ...
                                    <button className="bg-white text-background-dark hover:bg-slate-200 px-4 py-2 rounded-lg text-sm font-bold transition-colors">
                                        Request
                                    </button>
                                </div>
                            </motion.div>
                ...
                >
                    {/* XP Tracker */}
                    <div className="bg-card-dark rounded-2xl p-6 border border-white/10 flex flex-col gap-4 glass-card">
                        <div className="flex justify-between items-center">
                            <h3 className="text-white font-bold text-lg">Peer Coaching XP</h3>
                            <div className="bg-brand-blue/20 text-brand-blue p-1 rounded-md">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="h-3 w-full bg-black/20 rounded-full overflow-hidden">
                                <div className="h-full bg-brand-blue rounded-full relative" style={{ width: '80%' }}>
                    ...
                    <div className="bg-card-dark rounded-2xl p-6 border border-white/10 flex flex-col gap-4 glass-card">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <a className="text-brand-blue text-xs font-bold hover:underline" href="#">View All</a>
                        </div>
                    ...
                    {/* CTA Card */}
                    <div className="rounded-2xl p-6 bg-gradient-to-br from-brand-blue to-blue-900 text-white flex flex-col gap-3 relative overflow-hidden shadow-lg shadow-brand-blue/20">
                        ...
                        <button className="mt-2 bg-white text-brand-blue text-sm font-bold py-2 px-4 rounded-lg z-10 w-fit hover:bg-gray-100 transition-colors">Apply Now</button>
                    </div>
                </motion.div>
