...
export default function RoadmapPage() {
    ...
    return (
        <div className="bg-background-dark text-white font-sans overflow-hidden h-screen flex flex-col">
            {/* Top Navigation Bar */}
            <header className="flex-none z-50 bg-background-dark/80 backdrop-blur-md border-b border-white/10">
                <div className="px-6 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className="size-8 text-brand-blue">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-brand-blue/80 font-mono tracking-widest">COMPETENCY MATRIX v2.4</p>
                        </div>
                    </div>
                    {/* Profile Stats Mini (Integrated) */}
                    <div className="hidden md:flex items-center gap-6 px-6 py-2 bg-white/5 rounded-full border border-white/10">
                        <div className="flex flex-col items-center px-2">
                            <span className="text-xs text-slate-400 uppercase tracking-wide">Level</span>
                            <span className="text-brand-blue font-bold">12</span>
                        </div>
                        ...
                        <div className="h-8 w-px bg-white/10"></div>
                        <div className="flex flex-col items-center px-2">
                            <span className="text-xs text-slate-400 uppercase tracking-wide">XP</span>
                            <span className="text-white font-bold">850</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        <div className="flex gap-2">
                            <button className="flex size-10 cursor-pointer items-center justify-center rounded-lg bg-white/5 hover:bg-white/10 text-white transition-colors">
                        ...
                        <div className="size-10 rounded-full bg-cover bg-center border-2 border-white/10" style={{ backgroundImage: 'url("https://api.dicebear.com/7.x/avataaars/svg?seed=Felix")' }}></div>
                    </div>
                </div>
            </header>

            {/* Main Content Area: The Skill Tree Canvas */}
            <main className="flex-1 relative overflow-hidden bg-background-dark bg-grid-pattern">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <div className="relative w-full h-full z-10">
                        ...
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.1 }} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group cursor-pointer" onClick={() => setSelectedNode(null)}>
                            <div className="relative flex items-center justify-center size-24 rounded-full bg-card-dark border-2 border-brand-blue shadow-[0_0_10px_rgba(19,91,236,0.5),0_0_20px_rgba(19,91,236,0.3)] transition-transform group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(19,91,236,0.7),0_0_30px_rgba(19,91,236,0.5)]">
                                <span className="material-symbols-outlined text-4xl text-white">hub</span>
                                {/* Status Badge */}
                                <div className="absolute -bottom-2 bg-brand-blue text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">Mastered</div>
                            </div>
                            <span className="mt-4 text-white font-bold bg-black/50 px-3 py-1 rounded backdrop-blur-sm border border-brand-blue/30">Foundational Literacy</span>
                        </motion.div>
                        ...
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.2 }} className="absolute top-[30%] left-[30%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group cursor-pointer">
                            <div className="relative flex items-center justify-center size-20 rounded-full bg-card-dark border-2 border-brand-blue shadow-[0_0_10px_rgba(19,91,236,0.5),0_0_20px_rgba(19,91,236,0.3)] transition-transform group-hover:scale-110">
                        ...
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.3 }} className="absolute top-[15%] left-[20%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group cursor-pointer opacity-80 hover:opacity-100">
                            <div className="flex items-center justify-center size-16 rounded-full bg-card-dark border border-brand-blue/50 transition-transform group-hover:scale-110">
                                <span className="material-symbols-outlined text-2xl text-brand-blue">functions</span>
                            </div>
                        ...
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.3 }} className="absolute top-[15%] left-[40%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group cursor-pointer opacity-80 hover:opacity-100">
                            <div className="flex items-center justify-center size-16 rounded-full bg-card-dark border border-brand-blue/50 transition-transform group-hover:scale-110">
                                <span className="material-symbols-outlined text-2xl text-brand-blue">database</span>
                            </div>
                        ...
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.2 }} className="absolute top-[30%] left-[70%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group cursor-pointer">
                            <div className="relative flex items-center justify-center size-20 rounded-full bg-card-dark border-2 border-slate-700 transition-transform group-hover:scale-110 group-hover:border-white">
                        ...
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.3 }} className="absolute top-[15%] left-[60%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center opacity-50 grayscale">
                            <div className="flex items-center justify-center size-16 rounded-full bg-card-dark border border-slate-700">
                        ...
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.4 }} className="absolute top-[75%] left-[50%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center group cursor-pointer z-20" onClick={() => setSelectedNode('advanced-vis')}>
                            {/* Pulsing Ring */}
                            <div className="absolute inset-0 rounded-full animate-ping border border-brand-blue/50 opacity-75"></div>
                            <div className="relative flex items-center justify-center size-24 rounded-full bg-card-dark border-2 border-dashed border-brand-blue shadow-[0_0_30px_rgba(19,91,236,0.3)] transition-transform group-hover:scale-105">
                                <span className="material-symbols-outlined text-4xl text-white">neurology</span>
                                <div className="absolute -bottom-3 bg-card-dark border border-brand-blue/50 text-brand-blue text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider flex items-center gap-1">
                                    <span className="size-1.5 rounded-full bg-brand-blue animate-pulse"></span>
                                    In Progress
                                </div>
                            </div>
                            <span className="mt-5 text-brand-blue font-bold text-lg bg-black/60 px-4 py-1 rounded-lg backdrop-blur-md border border-brand-blue/50">Advanced Visualization</span>
                        </motion.div>
                    </div>
                </div>
                ...
                >
                    <div className="flex w-full items-stretch rounded-lg h-12 bg-white/5 backdrop-blur border border-white/10 shadow-lg group focus-within:border-brand-blue/50 focus-within:shadow-[0_0_10px_rgba(19,91,236,0.5),0_0_20px_rgba(19,91,236,0.3)] transition-all">
                ...
                >
                    ...
                    <div className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-3 items-center">
                        <div className="w-8 h-0.5 bg-brand-blue shadow-[0_0_8px_rgba(19,91,236,0.8)]"></div>
                        <p className="text-gray-300 text-xs">Verified Path</p>
                        <div className="w-8 h-0.5 border-t-2 border-dashed border-brand-blue"></div>
                        ...
                        <div className="size-3 rounded-full border border-brand-blue shadow-[0_0_5px_rgba(19,91,236,1)] bg-brand-blue/20"></div>
                ...
                <motion.div
                    initial={{ x: 50, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                    className={`absolute bottom-6 right-6 lg:right-[${selectedNode ? '420px' : '6rem'}] z-30 flex flex-col gap-2 transition-all duration-300`}
                >
                    <button className="size-10 flex items-center justify-center bg-white/5 backdrop-blur border border-white/10 rounded-lg text-white hover:bg-white/10 hover:border-brand-blue/50 active:scale-95 transition-all">
                        <span className="material-symbols-outlined">add</span>
                    </button>
                    <button className="size-10 flex items-center justify-center bg-white/5 backdrop-blur border border-white/10 rounded-lg text-white hover:bg-white/10 hover:border-brand-blue/50 active:scale-95 transition-all">
                        <span className="material-symbols-outlined">remove</span>
                    </button>
                    <button className="size-10 flex items-center justify-center bg-white/5 backdrop-blur border border-white/10 rounded-lg text-white hover:bg-white/10 hover:border-brand-blue/50 active:scale-95 transition-all" title="Reset View">
                ...
                <AnimatePresence>
                    {selectedNode && (
                        <motion.aside
                            ...
                            className="absolute top-0 right-0 h-full w-full max-w-[400px] bg-background-dark/95 backdrop-blur-xl border-l border-white/10 z-40 flex flex-col shadow-2xl"
                        >
                            {/* Sidebar Header */}
                            <div className="p-6 border-b border-white/10 flex justify-between items-start">
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="bg-brand-blue/20 text-brand-blue text-[10px] font-bold px-2 py-0.5 rounded border border-brand-blue/30 uppercase">Skill Node #104</span>
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-8">
                                ...
                                <div>
                                    <div className="flex justify-between items-end mb-2">
                                        ...
                                        <span className="text-brand-blue font-bold text-lg">60%</span>
                                    </div>
                                    <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden">
                                        <div className="h-full bg-brand-blue w-[60%] shadow-[0_0_10px_rgba(19,91,236,0.5)]"></div>
                                    </div>
                                ...
                                <div>
                                    <h4 className="text-white font-bold text-sm uppercase tracking-wider mb-2 flex items-center gap-2">
                                        <span className="material-symbols-outlined text-base text-brand-blue">info</span> About
                                    </h4>
                                ...
                                <div>
                                    <h4 className="text-white font-bold text-sm uppercase tracking-wider mb-3 flex items-center gap-2">
                                        <span className="material-symbols-outlined text-base text-brand-blue">account_tree</span> Prerequisites
                                    </h4>
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-brand-blue/30">
                                            <span className="material-symbols-outlined text-brand-blue text-xl">check_circle</span>
                                ...
                                <div>
                                    <h4 className="text-white font-bold text-sm uppercase tracking-wider mb-3 flex items-center gap-2">
                                        <span className="material-symbols-outlined text-base text-brand-blue">library_books</span> Learning Resources
                                    </h4>
                                    <div className="grid gap-2">
                                        <a className="flex items-center gap-3 p-3 rounded hover:bg-white/5 transition-colors group" href="#">
                                            <div className="size-8 rounded bg-white/5 group-hover:bg-white/10 flex items-center justify-center text-brand-blue">
                                                <span className="material-symbols-outlined text-lg">play_circle</span>
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm text-white truncate group-hover:text-brand-blue transition-colors">Module 4: Graph Theory Intro</p>
                                        ...
                                        <a className="flex items-center gap-3 p-3 rounded hover:bg-white/5 transition-colors group" href="#">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm text-white truncate group-hover:text-brand-blue transition-colors">D3.js Documentation Guide</p>
                            ...
                            <div className="p-6 border-t border-white/10 bg-black/20">
                                <button className="w-full flex items-center justify-center gap-2 bg-brand-blue hover:bg-blue-600 text-white font-bold py-3 px-4 rounded-lg shadow-[0_0_10px_rgba(19,91,236,0.5),0_0_20px_rgba(19,91,236,0.3)] hover:shadow-[0_0_15px_rgba(19,91,236,0.7),0_0_30px_rgba(19,91,236,0.5)] transition-all">
