...
export default function ScholarProfilePage() {
    return (
        <div className="min-h-screen bg-background-dark text-white font-sans p-8">
            ...
            <motion.div
                ...
                className="glass-card rounded-3xl p-8 border border-white/10 shadow-lg relative mb-8 overflow-hidden"
            >
                <div className="absolute top-0 right-0 w-1/3 h-full bg-brand-blue/5 rotate-12 blur-3xl"></div>

                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10">
                    <div className="flex items-center gap-6">
                        <div className="size-32 rounded-3xl bg-orange-100 border-4 border-white/10 overflow-hidden shadow-2xl relative">
                            ...
                            <div className="absolute bottom-0 inset-x-0 bg-brand-blue text-center text-[10px] font-bold py-1 uppercase tracking-widest text-white">
                                Verified
                            </div>
                        </div>
                        <div>
                    ...
                    <div className="flex flex-col items-end gap-4 min-w-[300px]">
                        <div className="flex gap-2">
                            <button className="bg-brand-blue text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 shadow-lg shadow-brand-blue/20 hover:bg-blue-600 transition-all active:scale-95">
                        ...
                        <div className="w-full">
                            <div className="flex justify-between text-xs font-bold uppercase mb-2 text-brand-blue">
                                <span>Level 4 Scholar</span>
                                <span className="text-slate-500">750/1000 XP</span>
                            </div>
                            <div className="h-3 w-full bg-white/5 rounded-full overflow-hidden border border-white/10">
                                <div className="h-full bg-brand-blue w-3/4 rounded-full shadow-[0_0_10px_rgba(37,99,235,0.5)]"></div>
                            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
                            <span className="material-symbols-outlined text-brand-blue">military_tech</span>
                        ...
                        <div className="bg-white/5 rounded p-1 flex text-[10px] font-bold border border-white/10">
                            <button className="bg-brand-blue text-white px-3 py-1 rounded shadow-sm">All</button>
                    ...
                    <div className="glass-card border border-white/10 rounded-[32px] p-8 min-h-[400px] flex items-center justify-center relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-4 gap-4 relative z-10 scale-90">
                            ...
                            <div className="col-span-4 flex justify-center gap-4 mb-4">
                                ...
                                <div className="w-24 h-28 relative flex items-center justify-center group cursor-pointer">
                                    ...
                                    <div className="relative z-10 text-center flex flex-col items-center transform group-hover:scale-110 transition-transform">
                                        <span className="material-symbols-outlined text-brand-blue text-2xl mb-1">lightbulb</span>
                                        <span className="text-[8px] font-bold text-brand-blue uppercase tracking-widest">Innovator</span>
                                    </div>
                                </div>
                                {/* Hex 2 */}
                                <div className="w-24 h-28 relative flex items-center justify-center group cursor-pointer">
                            ...
                            <div className="col-span-4 flex justify-center gap-4 -mt-10">
                                ...
                                <div className="w-24 h-28 relative flex items-center justify-center opacity-30">
                                    <svg className="absolute w-full h-full text-white/5" viewBox="0 0 100 115" fill="currentColor">
                                        <path d="M50 0 L93.3 25 V75 L50 100 L6.7 75 V25 Z" stroke="#4B5563" strokeWidth="1" />
                                    </svg>
                                    <div className="relative z-10 text-center flex flex-col items-center">
                                        <span className="material-symbols-outlined text-slate-500 text-2xl mb-1">science</span>
                                        <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest">Research</span>
                                        <span className="material-symbols-outlined text-[10px] text-slate-600 mt-1">lock</span>
                                    </div>
                                </div>
                                ...
                                <div className="w-24 h-28 relative flex items-center justify-center opacity-30">
                                    ...
                                    <div className="relative z-10 text-center flex flex-col items-center">
                                        <span className="material-symbols-outlined text-slate-500 text-2xl mb-1">volunteer_activism</span>
                                        <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest">Charity</span>
                                        <span className="material-symbols-outlined text-[10px] text-slate-600 mt-1">lock</span>
                                    </div>
                                </div>
                                ...
                                <div className="w-24 h-28 relative flex items-center justify-center opacity-30">
                                    ...
                                    <div className="relative z-10 text-center flex flex-col items-center">
                                        <span className="material-symbols-outlined text-slate-500 text-2xl mb-1">sports_esports</span>
                                        <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest">Gamer</span>
                                        <span className="material-symbols-outlined text-[10px] text-slate-600 mt-1">lock</span>
                                    </div>
                                </div>
                                ...
                                <div className="w-24 h-28 relative flex items-center justify-center opacity-30">
                                    ...
                                    <div className="relative z-10 text-center flex flex-col items-center">
                                        <span className="material-symbols-outlined text-slate-500 text-2xl mb-1">translate</span>
                                        <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest">Polyglot</span>
                                        <span className="material-symbols-outlined text-[10px] text-slate-600 mt-1">lock</span>
                                    </div>
                                </div>
                            </div>
                ...
                >
                    ...
                    {/* Skills Matrix */}
                    <div className="glass-card border border-white/10 rounded-[32px] p-8 hover:border-brand-blue/30 transition-colors">
                        <div className="flex items-center gap-2 mb-6">
                            <span className="material-symbols-outlined text-brand-blue">psychology</span>
                        ...
                        <div className="flex flex-wrap gap-2 mb-8">
                            {['Python', 'Public Speaking', 'Data Analysis', 'React.js', 'UI Design', 'Project Mgmt', 'Machine Learning', 'Technical Writing', 'Git'].map((skill, i) => (
                                <span key={skill} className={`text-xs font-bold px-3 py-1.5 rounded-full border transition-all hover:scale-105 cursor-default ${i < 5 ? 'bg-brand-blue border-brand-blue text-white shadow-lg shadow-brand-blue/40' : 'bg-white/5 border-white/10 text-slate-400 hover:text-white'}`}>
                                    {skill}
                                </span>
                            ))}
                        </div>

                        <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Recent Endorsements</h3>
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                <div className="size-8 rounded-full overflow-hidden border border-white/10">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=ProfA" className="w-full h-full" alt="Prof" />
                                </div>
                                <div className="text-xs">
                                    <p className="font-bold text-white">Prof. Miller</p>
                                    <p className="text-slate-500">Endorsed <span className="text-brand-blue">Data Analysis</span></p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="size-8 rounded-full overflow-hidden border border-white/10">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=ProfB" className="w-full h-full" alt="Prof" />
                                </div>
                                <div className="text-xs">
                                    <p className="font-bold text-white">Sarah Lee</p>
                                    <p className="text-slate-500">Endorsed <span className="text-brand-blue">Public Speaking</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Map Placeholder */}
                    <div className="flex-1 glass-card border border-white/10 rounded-[32px] overflow-hidden relative min-h-[200px] group">
                        ...
                        <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-background-dark via-background-dark/90 to-transparent p-6 pt-12">
