...
function EmotionalResultsContent() {
    ...
    const chartData = {
        labels: ['Self Awareness', 'Self Management', 'Social Awareness', 'Relationship Mgmt'],
        datasets: [
            {
                label: 'Your Profile',
                data: [
                    result.subdomains.self_awareness.score,
                    result.subdomains.self_management.score,
                    result.subdomains.social_awareness.score,
                    result.subdomains.relationship_management.score,
                ],
