            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link href="/community/war-room">
                    <motion.div
                        ...
                        className="group relative h-64 rounded-2xl overflow-hidden glass-card border border-brand-blue/30 cursor-pointer"
                    >
                        <div
                        ...
                        <div className="absolute bottom-0 left-0 p-6 w-full">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="bg-brand-blue size-10 rounded-lg flex items-center justify-center text-white shadow-lg shadow-brand-blue/30">
                            ...
                            <div className="flex items-center text-brand-blue text-xs font-bold uppercase tracking-wider gap-1">
